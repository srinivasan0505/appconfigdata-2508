# AWS AppConfig Data MCP Server

This MCP (Model Content Protocol) server provides access to AWS AppConfig Data API functionality through HTTP, HTTPS, and STDIO transport modes.
