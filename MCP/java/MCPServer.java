...
// Import Get_Configuration_Configuration_TokenMCPTool - included in same package
// Import Post_ConfigurationsessionsMCPTool - included in same package
...
public class MCPServer {
    ...
    public static void main(String[] args) {
        try {
            ...
            // Register all tools
            tools = Arrays.asList(
            Get_Configuration_Configuration_TokenMCPTool.createGet_Configuration_Configuration_TokenTool(config),
            Post_ConfigurationsessionsMCPTool.createPost_ConfigurationsessionsTool(config)
            );
